...
templates_path = ['Logilabtemplates']
...
exclude_patterns = ['Logilabbuild', 'Thumbs.db', '.DS_Store']
...
man_pages = [
    (master_doc, 'css', 'CSS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CSS', 'CSS Documentation',
     author, 'CSS', 'One line description of project.',
     'Miscellaneous'),
]
